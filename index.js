function getRandomImage() {  
    ...
    randomImage[0] = "./assets/painting/Leonardo_da_vinci.jpg";  
    randomImage[1] = "./assets/painting/vincent_van_gogh.jpg";  
    randomImage[2] = "./assets/painting/boticelli.jpg";  
    ...
    return document.getElementById("painting").innerHTML = '<img src="'+randomImage[number]+'" width="1000px" />';  
   // document.getElementById("painting").style.backgroundImage= "url('" + randomImage[number] + " ')"
}
