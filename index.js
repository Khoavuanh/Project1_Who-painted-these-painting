...
function getRandomImage() {  
    ...
    console.log("painting get#: "+ number);
    if (number==0){
    ...
    //document.getElementById("painting").innerHTML = '<img src="'+paintings[number]+'" width="1000px" />';  
    /*if (paintings[i] == 0){
        artist[0];
    }*/
...
//condition to hold and flip back
